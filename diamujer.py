...
<body>
    ...
    <h3>🌹Le deseo lo mejor en su día, sublime y valiosa mujer. Querida mamita. Quiero deserarle un excelente dia lleno de bendiciones.🌹</h3>
    ...
    <div id="M" class="letter-content">
        <h2>🌹Carta con M🌹</h2>
         <h3>Maravillosa, es una madre que ilumina la vida de todos a tu alrededor. Su bondad y dedicación son ejemplos de amor y entrega. Es alguien incomparable, y siempre estaré agradecido por todo lo que ha hecho por nosotros.</h3>
    ...
    <div id="U" class="letter-content">
        <h2>🌹Carta con U🌹</h2>
         <h3>Única, en cada sentido de la palabra. Su presencia deja una huella imborrable en quienes tienen la suerte de conocerla. Su alegría y carisma son contagiosos, y su belleza, tanto interior como exterior, es incomparable.</h3>
    ...
    <div id="J" class="letter-content">
        <h2>🌹Carta con J🌹</h2>
         <h3>Joya en espíritu, cuerpo y alma. Su juventud no se mide en años, sino en la pasión y el cariño que pone en todo lo que hace. Es una mujer invaluable para todos los que la conocen, y estoy agradecido de tenerla en mi vida.</h3>
    ...
    <div id="E" class="letter-content">
        <h2>🌹Carta con E🌹</h2>
         <h3>Especial, esa es la palabra que mejor la describe. Su alegría ilumina cualquier lugar, y su sonrisa es capaz de alegrar el día de cualquiera. Siempre estaré aquí para apoyarla incondicionalmente. Gracias por ser esa mujer valiente que esta aqui incondicionalmente para su familia, siendo una excelente esposa, madre y una gran mujer</h3>
    ...
    <div id="R" class="letter-content">
        <h2>🌹Carta con R🌹</h2>
         <h3>Radiante, su belleza es única y incomparable. Su valor y carisma llena de vida tanto por dentro como por fuera. Es una persona muy valiosa y una gran madre. Que su día esté lleno de bendiciones.</h3>
    ...
    <div id="❤" class="letter-content">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            ...
            <div style="margin: 20px;">
               <p>💖R - Radiante como el sol del amanecer💖</p>
               <p>💖O - Optimista y llena de vida💖</p>
               <p>💖C - Cariñosa en cada gesto y palabra💖</p>
               <p>💖I - Inspiradora en su sabiduría💖</p>
               <p>💖O - Orgullo de sus seres queridos💖</p>
            </div>
        </div>
